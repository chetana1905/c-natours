...
var hideAlert = function hideAlert(class_name) {
  var alert = document.querySelector('.alert');
  alert.style.display = 'none';
};

var showAlert = function showAlert(type, msg) {
  var class_name = type == 'error' ? 'alert-danger' : 'alert-success';
  var alert = document.querySelector('.alert');
...
exports.forgetPw = exports.signup = exports.login = void 0;
...
var forgetPw = /*#__PURE__*/function () {
  ...
  return function forgetPw(_x4) {
    return _ref3.apply(this, arguments);
  };
}();

exports.forgetPw = forgetPw;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"book.js":[function(require,module,exports) {
"use strict";
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              (0, _alert.showAlert)('error', "Something Went Wrong . Please try again later!");
            });
...
var user_update_form = document.querySelector(".user-update");
var update_pw_form = document.querySelector(".update-pw-form");
var book_tour = document.querySelector("#book_tour");
var sign_up = document.querySelector('.sign-up');
var forget_pw = document.querySelector('.forget_pw_btn');
...
if (book_tour) {
  book_tour.addEventListener('click', function () {
    var tourId = book_tour.dataset.tour_id;
    (0, _book.bookTour)(tourId);
  });
}
...
if (sign_up) {
  sign_up.addEventListener('click', function () {
    ...
    var confirm_password = document.getElementsByName('confirm_pw')[0].value;
    (0, _login.signup)({
      email: email,
      name: name,
      password: password,
